package com.hcl.hdfcproject.main;

import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;

import com.hcl.hdfcproject.model.Cards;
import com.hcl.hdfcproject.model.CreditCard;

public class MainSpringDI {

	public static void main(String[] args) {

		System.out.println("MainSpringDI.main()");
		ApplicationContext applicationContext= new ClassPathXmlApplicationContext("/spring/spring-config.xml");
		//Object obj=applicationContext.getBean("creditcard");
		//CreditCard ccObj=(CreditCard) obj;
		//System.out.println(ccObj.getCardNumber()+"\t"+ccObj.getCardHolderName()+"\t"+ccObj.getCvv()+"\t"+ccObj.getExpiryDate());
		
		//Object obj1=applicationContext.getBean("creditcard1");
		//CreditCard ccObj1=(CreditCard) obj1;
		//System.out.println(ccObj1.getCardNumber()+"\t"+ccObj1.getCardHolderName()+"\t"+ccObj1.getCvv()+"\t"+ccObj1.getExpiryDate());
